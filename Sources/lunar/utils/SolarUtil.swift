...
struct SolarUtil {
    ...
    static let WEEK: [String] = ["日", "一", "二", "三", "四", "五", "六"]
    
    static let DAYS_OF_MONTH: [Int] = [
        31,
        28,
        31,
        30,
    ...
    /// 日期对应的节日
    static let FESTIVAL: [String: String] = [
        "1-1": "元旦节",
        "2-14": "情人节",
        "3-8": "妇女节",
        "3-12": "植树节",
    ...
    /// 几月第几个星期几对应的节日
    static let WEEK_FESTIVAL: [String: String] = [
        "3-0-1": "全国中小学生安全教育日",
        "5-2-0": "母亲节",
        "6-3-0": "父亲节",
        "11-4-4": "感恩节"
    ...
    /// 日期对应的非正式节日
    static let OTHER_FESTIVAL: [String: [String]] = [
        "1-8": ["周恩来逝世纪念日"],
    ...
    /// @param year 年
    /// @return 天数
    static func getDaysOfYear(year: Int) -> Int {
